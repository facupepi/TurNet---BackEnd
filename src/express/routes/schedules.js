...
async function getAll(req, res) {
	return res.status(400).json({ message: 'No se puede obtener horarios.' });
	/*
...
async function create(req, res) {
	return res.status(400).json({ message: 'No se puede crear horarios.' });
	/*
	if (req.body.id) {
...
async function update(req, res) {
	return res.status(400).json({ message: 'No se puede actualizar horarios.' });
	/*
...
async function remove(req, res) {
	return res.status(400).json({ message: 'No se puede borrar horarios.' });
	/*
	const id = getIdParam(req);  // Valida y obtiene el ID del parámetro de la URL.
